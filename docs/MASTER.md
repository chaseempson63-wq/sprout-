...
> 2. **Sprout Resources**, the **web platform**, live at **hisprout.app/resources**. A free printable-template library + a premium AI worksheet + slideshow builder + a community where parents publish and share. The builder **DOES generate** (Venice AI for freeform; a deterministic engine renders the fixed templates instantly), under a **no-train / no-sell / no-share** promise. Separate product; the Journal's "no AI" fence does not bind it.
> **Free tier, count corrected 2026-07-18:** **336 templates, all free, no account, no email wall, no watermark, ages 3-13**. That is **306 illustrated story worksheets** (an original story per illustration plus questions and activities), each pre-authored in **6 difficulty versions** = **1,836 ready-to-print sheets**, plus **30 skill-practice templates** (math, phonics, spelling, handwriting) that generate a fresh sheet tuned to the kid's age. Difficulty changes the content (story length, sentence complexity, vocabulary, question type: recall, inference, evidence-citing, analysis), not just the question count. Any "free tier = the 30 templates" line elsewhere is stale. **Still premium:** build-your-own custom worksheets, slideshows, community, forum.
>
...
> **Pricing (updated 2026-07-18, app HEAD `d10ff41`):** the paywall now renders **live localized StoreKit prices**, so the price a parent sees is their real regional price and currency. Custom AU/NZ prices are set, and the **weekly base moved to ~$10 (USD fallback $9.99, down from $14.99)**. USD fallbacks in code: **$9.99/wk · $29.99/mo · $287.99/yr**. **Hard paywall** (no free trial). Share-a-friend gives **half price for the first month** (the old "$14.99 first month" line was wrong and is dead).
>
> **COPY RULE: never hardcode a weekly price, and never state one region's price as "the price."** Say "half price first month" for the share offer. The earlier locked line ($29.99/mo · $14.99/wk · $287.99/yr USD) is stale on the weekly. The body's "AUD $29/mo placeholder" is also dead.
