// A few ready-made worksheets so the Community library is not empty before a
// real shared backend exists. These render exactly like generated worksheets.

import type { Worksheet } from "./types";

export const COMMUNITY_SAMPLES: Worksheet[] = [
  {
    title: "Dinosaur Addition",
    subtitle: "Ages 5-7 · dinosaur",
    blocks: [
      { kind: "instructions", prompt: "Help the dinosaurs count their eggs. Solve each problem." },
      {
        kind: "math",
        prompt: "Write your answer in the box.",
        items: ["3 + 4 =", "5 + 2 =", "6 + 3 =", "4 + 4 =", "7 + 2 =", "1 + 8 ="],
        answers: ["7", "7", "9", "8", "9", "9"],
      },
  ...
  },
  {
    ...
    subtitle: "Ages 7-9 · space",
    blocks: [
      {
        kind: "passage",
        prompt: "Read the story, then answer the questions.",
        text: "Nova zipped past the moon in her little rocket. She wanted to find the brightest star in the sky. Along the way she counted seven planets, waved at a comet, and ate her lunch upside down. The best part of the trip was still ahead.",
      },
      {
        kind: "short-answer",
        prompt: "Answer in a full sentence.",
        items: ["Who is the story about?", "What did Nova want to find?", "How many planets did she count?"],
        rows: 2,
        answers: ["Nova", "the brightest star", "seven"],
      },
    ],
