...
function Capture() {
  return (
    <div className="relative">
      <div className="w-48 rounded-3xl bg-sprout-cream/[0.08] backdrop-blur-xl border border-sprout-cream/15 p-4 shadow-[0_30px_70px_-20px_rgba(0,0,0,0.6)] -rotate-3">
        <div className="h-32 rounded-2xl bg-gradient-to-b from-[#A4C9A8]/55 to-[#76A77A]/30 flex items-center justify-center mb-3">
          <ImageIcon className="w-9 h-9 text-sprout-cream/85" strokeWidth={1.75} />
        </div>
        <div className="h-2.5 rounded-full bg-sprout-cream/45 w-[82%] mb-2" />
        <div className="h-2.5 rounded-full bg-sprout-cream/25 w-[55%]" />
      </div>
      <div className="absolute -bottom-3 -right-3 w-14 h-14 rounded-full bg-gradient-to-b from-[#A4C9A8] to-[#76A77A] flex items-center justify-center shadow-[0_10px_24px_-6px_rgba(127,168,107,0.7)] border-2 border-[#1B3722]/15 p-3.5">
...
function Sort() {
  ...
  return (
    <div className="w-64 rounded-3xl bg-sprout-cream/[0.08] backdrop-blur-xl border border-sprout-cream/15 p-5 shadow-[0_30px_70px_-20px_rgba(0,0,0,0.6)] space-y-4">
      {rows.map((r, i) => (
        <div key={i} className="flex items-center gap-3.5">
          <span className="w-7 h-7 rounded-full shrink-0" style={{ backgroundColor: r.c }} />
          <span className="h-4 rounded-full" style={{ width: r.w, backgroundColor: r.c, opacity: 0.85 }} />
        </div>
      ))}
    </div>
  );
...
function Report() {
  ...
  return (
    <div className="w-56 rounded-2xl bg-[#F7F2E7] p-5 shadow-[0_30px_70px_-20px_rgba(0,0,0,0.6)] rotate-3 border border-[#1B3722]/10">
...
function Together() {
  return (
    <div className="flex items-center -space-x-6">
      <div className="w-28 h-28 rounded-full bg-gradient-to-b from-[#1F4D2E] to-[#143420] flex items-center justify-center shadow-[0_18px_40px_-12px_rgba(0,0,0,0.6)] border-2 border-sprout-cream/25 p-7">
        <User className="w-full h-full text-sprout-cream" strokeWidth={1.75} />
      </div>
      <div className="w-28 h-28 rounded-full bg-gradient-to-b from-[#A4C9A8] to-[#76A77A] flex items-center justify-center shadow-[0_18px_40px_-12px_rgba(0,0,0,0.6)] border-2 border-sprout-cream/25 p-7">
